...
<html lang="en">
    ...
    <body>
        ...
        <section class="section-steps" id="works">
            ...
            <div class="row">
                <div class="col span-1-of-2 steps-box">
                    <img src="resources/img/app-iPhone.png" alt="Omnifoot app on iPhone" class="app-screen js--wp-2">
                </div>
                <div class="col span-1-of-2 steps-box">
                ...
                <div class="col span-1-of-3">
                    <div class="plan-box">
                        <div>
                            ...
                            <p class="plan-price-meal">That's only $14.00 per meal</p>
                        </div>
                        <div>
                            <ul>
        ...
        <footer>
            ...
            <div class="row">
                <p>
                    Copywrite &copy; 2015 by Omnifood. All rights reserved.
                </p>
            </div>
        </footer>
